const apps = [
  {
    name: 'Hypurrmium',
    kicker: 'Buyback P/E',
    description: 'Spot the premium before the market does. Real-time HYPE P/E ratio built on daily buybacks.',
    url: 'https://hypurrmium.xyz/',
    tags: ['HYPE', 'P/E', 'Analytics'],
    accent: 'var(--accent-cyan)',
    image: './hypurrmium.webp',
    status: 'live',
  },
  {
    name: 'ExecutionCost',
    kicker: 'Execution Cost Comparator',
    description: 'Compare execution costs across DEXs — find where trading is cheapest across Variational, Hyperliquid, Lighter, Trade.xyz and more.',
    url: 'https://executioncost.xyz/',
    tags: ['DEX', 'Execution', 'Analytics'],
    accent: 'var(--accent-purple)',
    image: './assets/executioncost.png',
    status: 'live',
  },
  {
    name: 'MegaBunnish',
  ...
  {
    name: 'GetEuphoric',
    kicker: 'Euphoria Overlay',
    description: 'Chrome extension to display a TradingView chart overlay directly on EUphoria.',
    url: 'https://chromewebstore.google.com/detail/geteuphoric/jodlfcgjllnfkadhgcpdmaobdgicjijo',
    tags: ['Extension', 'TradingView', 'EUphoria'],
  ...
  },
  {
    name: 'MegaFees',
    kicker: 'Fee Tracker',
    description: 'Live fee dashboard for MegaETH activity and protocol economics.',
    url: 'https://megafees.com/',
    tags: ['Fees', 'MegaETH', 'Analytics'],
